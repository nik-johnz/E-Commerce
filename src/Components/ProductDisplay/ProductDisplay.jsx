  ...
  return (
    <div className='product-display'>
        ...
        <div className="product-display-right">
            ...
            <div className="product-display-right-des">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit mollitia excepturi maxime nesciunt minima perferendis, officia delectus eius rerum. Perferendis, aspernatur.
            </div>
